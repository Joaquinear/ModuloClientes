...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
    ...
    <section class="content-header">
      ...
      <h1>Reportes<small>Detalle de Sucursales</small>
      </h1>
    </section>
...
<div class="row">
            <div class="col-xs-12">
                <div> <!--  class="box box-solid" -->
                    <div class="box box-solid">
                    <div class="box-body">
                        <form method="post" target="_blank" action="../pdf/pdf/ReporteGeneralSucursal.php" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ddOficina" class="col-sm-3 control-label">Sucursal</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="ddOficina" class="col-sm-3 control-label">Gestión</label>
                                                 <div class="col-sm-9">
                                                <select  name="fecha1" class="form-control">
