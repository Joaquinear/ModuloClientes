...
include_once "../template/s_encabezado.php"; ?>
                            ...
                            <div class="box-body">
                                ...
                                <div id="no-more-tables">
                                    <table class="col-md-12 table-bordered table-hover table-striped table-condensed cf" id="tablapaquetes" style="padding:0">
                                        ...
                                        <tbody>
                                            <?php
    $listaPaquete= $clientes->TraerLotesVendidos_Reservados();
    ...
    while (! $listaPaquete->EndOfSeek()) {    
        ...
        {
          $cliente = $row->clienteR;
          $trabajador = $row->trabajadorR;
          
        }
        if($row->estado=="vendido")
        {
          $cliente = $row->clienteV;
          $trabajador = $row->trabajadorV;
          
        }
        

        echo "<td data-title='ESTADO'>".$trabajador."</td>";
        echo "<td data-title='ESTADO'>".$cliente."</td>";
        // 
