...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="20mm">
     ...
     <page_footer> 
        ...
        echo '<div col_2>';
    echo '<img src="../../images/fgym.jpg" width="150" align="right">'.'<H1>Reporte General de Actividades</H1><br>
...
echo '<table id="tabla">
        ...
        $listaMensualidad=$iReporte->DetalleCantidadActividades($oficina,$fechaini,$fechafin);
    $listaMensualidad->MoveFirst();
    $contador=0;
    while (! $listaMensualidad->EndOfSeek()) {    
        $row = $listaMensualidad->Row();
        echo "<tr>";
        echo "<td class='numeric' data-title='Nro'>".$row->codActividad."</td>";
